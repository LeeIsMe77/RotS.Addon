namespace RotS.LineParser.Core.Extensions {
	...
	/// <summary>
	/// A set of commonly used extension methods for the <seealso cref="XElement"/> type.
	/// </summary>
	public static class XElementExtension {

		/// <summary>
		/// Retrieves the attribute of the supplied name and safely returns its value as a the type specified.
		/// </summary>
		/// <typeparam name="T"></typeparam>
		/// <param name="element">The element.</param>
		/// <param name="attributeName">Name of the attribute.</param>
		/// <returns>The value of the attribute converted to the type specified. If the element or attribute is null, or the conversion can't be performed, then the default value of the type specified.</returns>
		public static T SafeAttributeValue<T>(this XElement element, XName attributeName) {
			...
			try {
				if (typeof(T).IsEnum) {
					...
					convertedType = (T)TypeDescriptor.GetConverter(typeof(T)).ConvertFromString(extractedAttribute.Value);
				}
				else {
